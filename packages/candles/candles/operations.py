...
from candles.utils import round_down_to_nearest_interval, time_passed_interval_start
...
def merge_candles(
    ...
    if prev_candle is None:
        prev_candle = candle.copy(
            timeframe=timeframe,
            timestamp=round_down_to_nearest_interval(candle.timestamp, timeframe.ms)
        )
